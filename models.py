...
class User(db.Model, UserMixin):
    ...
    role = db.Column(db.String(20), nullable=False, default='Public User') # Admin, Traffic Operator, Public User
...
class TrafficData(db.Model):
    ...
    congestion_level = db.Column(db.String(20), nullable=False) # Low, Moderate, Heavy
